...
import {
  createModuleFederationSsrModuleLoader,
  WebpackShareScopes,
  WebpackInitSharing,
} from '@feature-hub/module-loader-federation-ssr';
import {
  Css,
...
export default async function renderApp({
  ...
  console.log('starting integrator');
  const {featureAppManager, featureServices} = createFeatureHub(
    'test:integrator',
    {
      moduleLoader: createModuleFederationSsrModuleLoader(
