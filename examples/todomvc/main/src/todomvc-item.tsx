import {Todo} from '@vwa/feature-services';
...
const ListItem = styled<ListItemProps, 'li'>('li')`
	position: relative;
	font-size: 24px;
...
const View = styled<ViewProps, 'div'>('div')`
...
const EditInput = styled<EditInputProps, 'input'>('input')`
			...
			<ListItem editing={editing} completed={completed}>
				<View editing={editing}>
					<Toggle
						type="checkbox"
						checked={completed}
						onClick={event => onToggle(id, event.currentTarget.checked)}
					/>
					<Label
						completed={completed}
